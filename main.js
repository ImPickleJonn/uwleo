(function () {
  ...
  const I18N = {
    he: {
      ...
      aboutP2: 'מאז 2022, לצד הסיפורת, U.W. Leo כותב גם מאמרונים פילוסופיים-אישיים. הם נעים בין רפלקציה אישית להגות על שאלות יסוד — מהותו של היקום, מקומו של האדם בו, האהבה, הסבל, אלוהים, ומשמעות. אסופת המאמרונים מובאת כאן באתר במלואה.',
      aboutP3: 'חוויה מיוחדת ש-U.W. Leo חווה בכתיבתו היא התחושה שהספר כותב את עצמו, כשהסיפור מתעורר לחיים כמעט מעצמו, ושהסיפור עצמו אף כותב חלק מקיומו שלו. הוא מוצא בתהליך הזה דבר נשגב — בבואה אמיתית של פלא החיים.',
      aboutP4: 'כשאינו כותב סיפורי נוער מרתקים, U.W. Leo נהנה ללמוד דברים חדשים, לקרוא, לראות סרטים ולשחק שחמט. אחת ההנאות הגדולות ביותר שלו היא פשוט שיחה וכוס קפה עם חבר או בן משפחה.',
    ...
    en: {
      ...
      aboutP2: 'Since 2022, alongside his fiction, U.W. Leo has been writing personal-philosophical essays. They move between intimate reflection and thought on fundamental questions — the nature of the universe, the place of the human within it, love, suffering, God, and meaning. The full collection of those essays is gathered here on this site.',
      aboutP3: 'An interesting experience U.W. Leo has while writing is the feeling that the book is writing itself, as the story comes to life on its own, seemingly with no control from him, and that the story is also writing a part of his own existence. He finds this process magnificent — a true reflection of the wonder of life itself.',
      aboutP4: 'When he isn\'t writing captivating young adult stories, U.W. Leo enjoys learning new things, reading, watching movies, and playing chess. One of his greatest pleasures is simply having a chat and coffee with a friend or family member.',
