...
const BOOKS = [
  {
    ...
    reviews: [
      ...
      { source: 'BookLife by Publishers Weekly', quote_en: 'ARKO: The Dark Union is an essential addition to the young adult library with dynamic characters, an emphasis on scientific realism, important themes for today\'s audiences, and an exciting story with enormous stakes.', quote_he: 'ARKO: ברית האופל היא תוספת חיונית לספריית הנוער, עם דמויות דינמיות, דגש על ריאליזם מדעי, נושאים חשובים לקהל של ימינו, וסיפור מותח עם סיכונים עצומים.' },
